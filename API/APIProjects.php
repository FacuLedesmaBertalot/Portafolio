...
$projects = [
  ...
  [
    "title" => "Regal Realty",
    "desc" => "Este proyecto fue desarrollado como trabajo final para la materia Programación Estática de la Tecnicatura en Desarrollo Web (UNCo). Se trata de una aplicación web diseñada para una inmobiliaria ficticia, enfocada en la presentación de propiedades y la interacción básica con el usuario.",
    "long_desc" => "...",
